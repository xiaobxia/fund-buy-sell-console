...
@AllArgsConstructor
@NoArgsConstructor
public class HsCert implements Serializable {

    private static final long serialVersionUID = 769962539038307243L;
    @Id
    /**
     * 自增ID
     */
    ...
    /*@OneToMany
    @JoinTable(name="HS_CERT_DTL",
            inverseJoinColumns = {
                    @JoinColumn(name = "certId",referencedColumnName="phid",insertable = false,updatable = false)
            })*/
    @OneToMany(mappedBy = "certId")
    @OrderBy("SORT ASC")
//    @JoinColumn(name="CERT_ID",referencedColumnName="PHID")
    private List<HsCertDtl> hsCertDtlList;
}
