import storageNettosUtil from '@/utils/storageNettosUtil'
...
export default {
  ...
  removeLoginAuth() {
    ...
    // 为兼容网报平台
    storageNettosUtil.removeItem('orgInfo')
    storageNettosUtil.removeItem('userInfo')
    storageNettosUtil.removeItem('token')
    storageNettosUtil.removeItem('role')
  },
  // 返回登录，为应对不同平台抽象
